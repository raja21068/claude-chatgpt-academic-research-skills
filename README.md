...
Academic Research Skills for Claude and Chatgpt ( No API KEY)
...
!\[AI Processing](./main\_image2.png)  
...
\- ARIS Methodology: \[Auto-claude-code-research-in-sleep](https://github.com/wanshuiyin/Auto-claude-code-research-in-sleep) :contentReference\[oaicite:0]{index=0}  

\- PaperOrchestra: \[PaperOrchestra GitHub](https://github.com/raja21068/PaperOrchestra) :contentReference\[oaicite:1]{index=1}  
